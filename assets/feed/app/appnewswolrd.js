let worldurl = 'http://rssfeeds.sanook.com/rss/feeds/sanook/news.world.xml';
const textarea_world = document.querySelector('#feed-textarea-world > ul');

feednami.load(worldurl)
  .then(feed => {
    textarea_world.value = ''
    console.log(feed);
